...
\keywords[cs]{líhnutí kódu, programovací jazyk, CTFE, metaprogramování, OOP}
\keywords[en]{code hatching, programming language, CTFE, metaprogramming, OOP}
...
\acknowledgment{Velký dík patří i Stefanu Kochovi, který se na internetu vyskytuje pod přezdívkou UplinkCoder; ve své ochotě se mnou prodebatoval velkou část konceptu jazyka. 
