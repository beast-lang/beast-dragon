...
\projectinfo{
  ...
  title.cs={Překladač nového modulárního jazyka},  %nazev prace v cestine ci slovenstine (dle zadani) / thesis title in czech language (according to assignment)
  title.en={Compiler of new modular language}, %nazev prace v anglictine / thesis title in english
  %Autor / Author
  ...
  %Skolitel / supervisor
  supervisor=Zbyňek Křivka, %cele jmeno a prijmeni skolitele / full name and surname of the supervisor
