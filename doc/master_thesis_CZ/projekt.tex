...
\projectinfo{
  ...
  title.cs={Líhnutí kódu a výpočet za doby kompilace v programovacích jazycích},  % název práce v češtině či slovenštině (dle zadání) / thesis title in czech language (according to assignment)
  title.en={Code Hatching and Compile-Time Computation in Programming Languages}, % název práce v angličtině / thesis title in english
  %title.length={14.5cm}, % nastavení délky bloku s titulkem pro úpravu zalomení řádku (lze definovat zde nebo níže) / setting the length of a block with a thesis title for adjusting a line break (can be defined here or below)
  %Autor / Author
  author.name={Daniek},   % jméno autora / author name
  ...
  keywords.cs={líhnutí kódu, beast, programovací jazyk, vykonávání kódu během kompilace}, % klíčová slova v českém či slovenském jazyce / keywords in czech or slovak language
  keywords.en={code hatching, beast, programming language, compile-time function execution, CTFE}, % klíčová slova v anglickém jazyce / keywords in english
